...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      meta: [
        { hid: 'description', name: 'description', content: "Improve stretch初回限定価格 | Improve stretch | 寝屋川 | 香里園 | ストレッチ" },
        { name: 'keywords', content: '香里園,寝屋川,ストレッチ,インプルーブストレッチ,前屈,開脚,ゴルフ,スコアアップ,ストレッチ,柔軟,,腰痛,肩こり,痺れ,巻き肩,頭痛,むくみ,冷え性,体験,姿勢不良,姿勢改善' },
        { property: 'og:title', content: 'Improve stretch初回限定価格 | Improve stretch | 寝屋川 | 香里園 | ストレッチ' },
        ...
        { property: 'og:site_name', content: 'Improve stretch初回限定価格 | Improve stretch | 寝屋川 | 香里園 | ストレッチ' },
